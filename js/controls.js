const PatternButtons = {
  ...
  buttons: [
    { name: 'C',  midi: 36, group: 'pink' },
    { name: 'C#', midi: 37, group: 'pink' },
    { name: 'D',  midi: 38, group: 'pink' },
    { name: 'D#', midi: 39, group: 'pink' },
    { name: 'E',  midi: 40, group: 'pink' },
    { name: 'F',  midi: 41, group: 'pink' },
    { name: 'F#', midi: 42, group: 'pink' },
    { name: 'G',  midi: 43, group: 'pink' },
    { name: 'G#', midi: 44, group: 'yellow' },
    { name: 'A',  midi: 45, group: 'yellow' },
    { name: 'Bb', midi: 46, group: 'yellow' },
    { name: 'B',  midi: 47, group: 'green' },
  ],
